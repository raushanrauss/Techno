...
const EditProfile = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const { data } = await axios.post("https://techno-3.onrender.com/user/editProfile", formdata, config)
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="profile-ımg-upld-wrapper">
                                ...
                                <div class="currentImage">
                                    ...
                                    <img src={`https://techno-3.onrender.comh/userPhotos/${previousPhoto}`} alt="userPhoto" />
                                </div>
