...
const DetailStory = () => {
  ...
  useEffect(() => {
    ...
    const getDetailStory = async () => {
      ...
      var activeUser = {}
      try {
        const { data } = await axios.get("https://techno-3.onrender.com/auth/private", {
          headers: {
      ...
      try {
        const { data } = await axios.post(`https://techno-3.onrender.com/story/${slug}`, { activeUser })
        setStory(data.data)
  ...
  const handleLike = async () => {
    ...
    try {
      const { data } = await axios.post(`https://techno-3.onrender.com/story/${slug}/like`, { activeUser }, {
        headers: {
          "Content-Type": "application/json",
          authorization: `Bearer ${localStorage.getItem("authToken")}`,
        },
  ...
  const addStoryToReadList = async () => {
    ...
    try {
      ...
      const { data } = await axios.post(`https://techno-3.onrender.com/user/${slug}/addStoryToReadList`, { activeUser }, {
        headers: {
          "Content-Type": "application/json",
          authorization: `Bearer ${localStorage.getItem("authToken")}`,
        },
            ...
            <div className='Inclusive-detailStory-page'>
                  ...
                  <ul>
                    {story.author &&
                      <li className='story-author-info'>
                        <img src={`https://techno-3.onrender.com/userPhotos/${story.author.photo}`} alt={story.author.username} />
              ...
              <div className='story-content' >
                ...
                <div className="story-banner-img">
                  <img src={`https://techno-3.onrender.com/storyImages/${story.image}`} alt={story.title} />
