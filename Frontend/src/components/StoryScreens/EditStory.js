...
const EditStory = () => {
    ...
    useEffect(() => {
        ...
        const getStoryInfo = async () => {
            setLoading(true)
            try {
                const { data } = await axios.get(`https://techno-3.onrender.com/story/editStory/${slug}`, config)
                setStory(data.data)
                    ...
                    <div className="Inclusive-editStory-page ">
                        <form onSubmit={handleSubmit} className="editStory-form">
                            ...
                            <div class="currentlyImage">
                                ...
                                <img src={`https://techno-3.onrender.com/storyImages/${previousImage}`} alt="storyImage" />
                            </div>
